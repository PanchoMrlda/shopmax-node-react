...
export default function Cart() {
    ...
    const increase2 = () => setQuantity2(q => q + 1);
    const decrease2 = () => setQuantity2(q => (q > 1 ? q - 1 : 1));
                            ...
                            <div className="site-blocks-table">
                                <table className="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td className="product-name"><h2 className="h5 text-black">Polo Shirt</h2></td>
                                        <td>$49.00</td>
                                        <td>
                                            <div className="input-group mb-3" style={{maxWidth: "120px"}}>
                                                <div className="input-group-prepend">
                            ...
                            <div className="row justify-content-end">
                                <div className="col-md-7">
                                    ...
                                    <div className="row mb-3">
                                        <div className="col-md-6"><span className="text-black">Subtotal</span></div>
                                        <div className="col-md-6 text-right">
                                            <strong className="text-black">$230.00</strong>
                                        </div>
                                    </div>
                                    <div className="row mb-5">
                                        <div className="col-md-6"><span className="text-black">Total</span></div>
                                        <div className="col-md-6 text-right">
                                            <strong className="text-black">$230.00</strong>
                                        </div>
                                    </div>
